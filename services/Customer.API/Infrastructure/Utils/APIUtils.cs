...
namespace Customer.API.Infrastructure.Utils {
    public static class APIUtils {
        ...
        public static IQueryable<TEntity> ParseFields<TEntity> (this IQueryable<TEntity> query, String fields) {
            ...
            PropertyInfo property = query.ElementType.GetProperty ("Id");
            ParameterExpression paramExpression = Expression.Parameter (query.ElementType, "p");
            MemberExpression propertyExpression = Expression.Property (paramExpression, property);

            LambdaExpression columnLambda = Expression.Lambda (propertyExpression, paramExpression);
